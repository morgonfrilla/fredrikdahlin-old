$(function() {
	...
	***************************************************************************************/
	...
	function insertImage(date, width, start, id, title) {
		...
		img.setAttributeNS('http://www.w3.org/1999/xlink','href','images/'+date+'/timeline.jpg');
		    ...
		    success: function(msg){
		    	...
		    	if (posts.length > 0) {
			    	...
			    	for (var i = 0; i < posts.length; i++) {
				    	...
				    	$(".post_container").append("<div class=\"post\"><div class=\"post_header post_header_"+id+"\"><h1>"+header_title+"</h1></div><div class=\"text\"><section><h2>"+title+"</h2><h3>"+start_date+" till "+end_date+"</h3>"+text+"</div>"+sidebar); 
